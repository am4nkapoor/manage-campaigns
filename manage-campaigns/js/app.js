...
const jsonURL = "https://raw.githubusercontent.com/am4nkapoor/manage-campaigns/master/db.json";
const getData = paramFilter => {
    $("tbody").html("");
    fetch(jsonURL)
        .then(res => res.json())
        .then(data => {
            //FILTER ALL THE DATA BASED ON DATES
        ...
        function getDiff(date){
            ...
            const drawDOM = () => {
                ...
                <td data-attr="view" class="cell-pricing show-modal">
                    <span class="circel bg-blue"><i class="fas fa-dollar-sign"></i>
                ...
                <td data-attr="actions" class="actions uppercase">
                    <a href="javascript:void(0);"><i class="fas fa-file-alt"></i><br />csv</a>
                    <a href="javascript:void(0);"><i class="fas fa-chart-bar"></i><br />reports</a>
                    <a href="javascript:void(0);" class="btnSchedule"><i class="fas fa-calendar-alt"></i><br />schedule
                        again</a>
                </td>
            </tr>
                `;
            ...
            // TEMPLETE LITERALS FOR LOAD ALL DATA
